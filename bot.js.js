...
client.on('ready', function(){
    var ms = 10000 ;
    var setGame = [' $help','PuP | System','Have Fun !',' Iam Here For Games',' $help'];
    var i = -1;
    var j = 0;
  ...
  console.log('---------------');
  console.log('PuP | System Is Online')
  console.log('---------------')
});
...
client.on('message', message => {
    var prefix = "$";
      ...
      if (message.author.id == 529204208407281665) return;
...
client.login("NTMxMDk5MDc2MzE0Mzk4NzQ1.DxJAWw.RI7b6DbY63MGQBY6L4zfIwPonuA");